...
const TGA3 = () => {
    ...
    const processCombinedChartDataCSV = () => {
        ...
        setApi(filteredDates.map((item, index) => [item, filteredData[index]]));
    ...
    const processCombinedChartDataCSV3 = () => {
        ...
        setApi3(filteredDates.map((item, index) => [item, filteredData[index]]));
    ...
    const processCombinedChartDataCSV2 = () => {
        ...
        setApi2(filteredDates.map((item, index) => [item, filteredData[index]]));
